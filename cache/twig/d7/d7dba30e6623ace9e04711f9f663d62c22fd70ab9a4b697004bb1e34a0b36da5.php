...
($context["bytes"] ?? null) < ($context["terabyte"] ?? null))) {
        ...
        ";
            ...
            // line 21
            echo "    ";
            $___internal_aaaba2de6e2e778fbc4f7259ad7374a4e1ec2a686045279578168b48a2e097b3_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 4
            echo twig_spaceless($___internal_aaaba2de6e2e778fbc4f7259ad7374a4e1ec2a686045279578168b48a2e097b3_);
        } catch (\Exception $e) {
            ob_end_clean();
...
{% block input %}
    ...
    {% endif %}
{% endblock %}
", "forms/fields/file/file.html.twig", "/home/user/decordtferre/www/user/plugins/admin/themes/grav/templates/forms/fields/file/file.html.twig");
    }
}
